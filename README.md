...
- When context has grown by 200K tokens, a 165-token nudge is added to the conversation. It
...
**1232 lines of source, 9 tests.** One tool, one config key, no slash command.
