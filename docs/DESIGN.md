...
**Progress** (§16 build order). All five steps are landed. 1,232 source lines, 521 test lines,
9 tests. What has and has not been verified is §19.
...
| File | Purpose | Lines |
|---|---|---|
| `fold.ts` | the one tool: the menu, the spans, the records, the receipt | 272 |
...
| **Total** | **1,232**, against a first estimate of ~830. | |
...
**Nine tests, 521 lines.** They build their own fixtures and depend on nothing outside the
...
Module estimate: **~950 lines**; the tree is 1,232. Down from ~990, ~1,385, ~1,810 in the first draft, and
